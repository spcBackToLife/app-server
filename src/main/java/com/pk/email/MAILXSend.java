 ...
 * Then,send the request data by a mode of mail.It is diffirent from
 * {@link MAILSend} ,user don't need to offer html source or mail content,or
 * even mail title and sender, change the mail content by variable dynamicly if
 * prividing only id which created in submail application.
 * 
 * @see MAILSend
 * @see Mail
 * 
