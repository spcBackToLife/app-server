...
/**
 * A class extends TreeMap in order to store the request data with format of
 * key-value. Such as appid, appkey, to and other information.The TreeMap ensure
 * that the key can be sorted descending to create signature.
 * 
...
public class DataStore extends TreeMap<String, Object> {
	...
	/**
	 * Define a adding pattern that data can be added to map one by one but
	 * displayed with a string separated by comma. For Example, <code> 
	 * addWithComma("K", "v1");
	 * addWithComma("K", "v2");
	...
	/**
	 * Define a adding pattern that data can be added to map one by one but
	 * displayed with a string decorated by angle brackets. For Example, <code> 
	...
	/**
	 * Define a adding pattern that data can be added to map one by one but
	 * displayed with a json. For Example, <code> 
