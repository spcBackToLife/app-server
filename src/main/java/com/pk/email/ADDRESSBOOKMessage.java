...
/**
 * A SenderWapper class as decoration class for user to subscribe and
 * unsubscribe by message. User can set the basic information of request by
 * included several methods. Then,send the request data by a mode of message.
 * 
 * @see Mail
 * 
