...
import com.pk.email.AppConfig;
import com.pk.email.ConfigLoader;
import com.pk.email.MAILSend;
...
public class SendEmail {
	...
	public static String myEmailAccount = "QianXunEngram@outlook.com";
	public static String myEmailPassword = "LiSH19940102";
	...
	// 收件人邮箱（替换为自己知道的有效邮箱）
	public static String receiveMailAccount = "1457431899@qq.com";

	public static void main(String[] args) throws Exception {
		sendEmail(receiveMailAccount, "2012");
	}

	public static void sendEmail(String email, String recognizeCode) throws Exception {
		...
		// 3. 创建一封邮件
		MimeMessage message = createMimeMessage(session, myEmailAccount, email, recognizeCode);
	...
	public static void send(String to, String sender, String text, String subject, String html, String senderName,
			String reply) {
	...
	public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,
			String recognizeCode) throws Exception {
		System.out.println("接收邮箱:" + receiveMail);
		// 1. 创建邮件对象
		...
		text.setContent("your verification code is :" + recognizeCode, "text/html;charset=UTF-8");
		...
		// attachment.setFileName(MimeUtility.decodeText(dh2.getName())); //
		// 设置附件的文件名（需要编码）
